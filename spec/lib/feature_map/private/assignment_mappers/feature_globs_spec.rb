        ...
        it 'lets the user know that `assigned_globs` can not overlap' do
          expect { FeatureMap.validate! }.to raise_error do |e|
            ...
            expect(e.message).to eq <<~EXPECTED.chomp
              ...
              - `packs/**/**` (from `.feature_map/definitions/bar.yml`), `packs/**/**` (from `.feature_map/definitions/foo.yml`)
              - `frontend/javascripts/blah/subdir/my_file.rb` (from `.feature_map/definitions/bar.yml`), `frontend/javascripts/blah/**/**` (from `.feature_map/definitions/foo.yml`)
