      ...
      <div className="flex items-center gap-4">
        ...
        <ul className="flex flex-col flex-1 gap-y-1">
          <li className="flex items-center gap-x-2">
            <div className={`flex-shrink-0 rounded size-5 flex items-center justify-center ${getFeatureSizeColor(featureSizes.xs).class}`}>
          ...
          <li className="flex items-center gap-x-2">
            <div className={`flex-shrink-0 rounded size-5 flex items-center justify-center ${getFeatureSizeColor(featureSizes.s).class}`}>
          ...
          <li className="flex items-center gap-x-2">
            <div className={`flex-shrink-0 rounded size-5 flex items-center justify-center ${getFeatureSizeColor(featureSizes.m).class}`}>
          ...
          <li className="flex items-center gap-x-2">
            <div className={`flex-shrink-0 rounded size-5 flex items-center justify-center ${getFeatureSizeColor(featureSizes.l).class}`}>
          ...
          <li className="flex items-center gap-x-2">
            <div className={`flex-shrink-0 rounded size-5 flex items-center justify-center ${getFeatureSizeColor(featureSizes.xl).class}`}>
