      ...
      <div className="flex items-center justify-between">
        ...
        {tooltip && (
          <div className="relative shrink-0 group">
            ...
            <div className="absolute whitespace-nowrap bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block bg-gray-700 text-white text-xs rounded-sm py-1 px-2">
              {tooltip}
            </div>
          </div>
        )}
