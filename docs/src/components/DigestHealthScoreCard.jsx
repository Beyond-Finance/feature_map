      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <ul className="flex flex-col flex-1 gap-y-2">
          <li className="flex items-center gap-x-2">
            ...
            <p className="text-sm text-gray-500">Features needing attention</p>
          </li>
          <li className="flex items-center gap-x-2">
            <div
            ...
            <p className="text-sm text-gray-500">Features needing improvement</p>
          </li>
          <li className="flex items-center gap-x-2">
            <div
            ...
            <p className="text-sm text-gray-500">Healthy Features</p>
          </li>
        </ul>
      </div>
    </div>
