document.addEventListener("DOMContentLoaded", function() {
  ...
  Object.keys(window.FEATURES).forEach(feature_name => {
    ...
    abc_size_td.classList.add("metric-value");
    ...
    lines_of_code_td.classList.add("metric-value");
    ...
    cyclomatic_complexity_td.classList.add("metric-value");
    ...
    file_count_td.classList.add("metric-value");
    file_count_td.appendChild(document.createTextNode(feature_data.assignments.length));
