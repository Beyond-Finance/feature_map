window.FEATURE_MAP_CONFIG = {
    ...
    "project": {
      "assigned_globs":["app/**/*.rb"],
      "unassigned_globs":["app/models/**/*"],
      "ignore_feature_definitions":true,
      "skip_code_ownership":false,
      "code_cov":{"service":"github","owner":"Example","repo":"abcd"},
      "repository":{"main_branch":"main","url":"https://example.com/blob/abcd"},
      "documentation_site":{
        "health":{
          "minimum_thresholds":{"good":95,"fair":80,"poor":0},
          "components":{
            "cyclomatic_complexity":{"weight":15,"minimum_variance":10,"score_threshold":100},
            "encapsulation":{"weight":15,"minimum_variance":10,"score_threshold":100},
            "test_coverage":{"weight":70,"score_threshold":98}
          }
        },
        "size_percentile":{
          "minimum_thresholds":{"xl":95,"l":75,"m":25,"s":5,"xs":0}
        },
        "test_coverage":{
          "minimum_thresholds":{"good":98,"fair":95,"poor":0}
        }
      }
    },
    "features": {
